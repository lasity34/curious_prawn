...
export const getGeoData = ({lat, lng}) => {
  try {
    const data = axios(`https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${lat}${lng}&radius=1500&&type=restaurant&AIzaSyAUFsJ-sdQtILh7X70aTfSw4LGeCrMHxjQ`)
    .then(res => res.json())
