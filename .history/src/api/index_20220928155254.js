...
export const getGeoData = ({lat, lng}) => {
  ...
  try {
    const data = axios(`https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=-33.8670522%2C151.1957362&radius=1500&type=restaurant&keyword=cruise&key=AIzaSyAUFsJ-sdQtILh7X70aTfSw4LGeCrMHxjQ`)
    .then(res => res.json())
