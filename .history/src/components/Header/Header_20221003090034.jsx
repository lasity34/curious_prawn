...
const Header = ({
  ...
  const [itemExpand, setItemExpand] = useState(true)
        ...
        <Toolbar className={classes.toolbar}>
          <div className={classes.topHead} style={{ width: "100%" }}>
            ...
            <Box className={classes.box} display="flex">
              {isDesktop ? <Autocomplete onLoad={onLoad} onPlaceChanged={onPlaceChanged}>
              ...
              </Autocomplete> : itemExpand ? <Autocomplete onLoad={onLoad} onPlaceChanged={onPlaceChanged}>
                <div className={classes.search}>
                  <div className={classes.searchIcon}>
                    <SearchIcon />
                  </div>
              ...
              </Autocomplete> : <SearchIcon onclick={handleClick} />}
              
            </Box>
            </Link>
          </div>
          <Box display="flex" margin=" 0.5em 0.2em" justifyContent='space-around' >
